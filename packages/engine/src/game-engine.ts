...
import { BlueprintConverter } from "./object-system/blueprint-converter.js";
import { Room } from "./object-system/room.js";

export interface GameEngineOptions {
  uiEventHandler: UIEventHandler;
  naturalLanguageProcessor: any; // Required AI NLP
  narrator?: any; // Optional AI narrator
  conversationHandler?: any; // Optional conversation handler
}
...
export class GameEngine {
  ...
  constructor(blueprint: Blueprint, options: GameEngineOptions) {
    ...
    // Inject spatial manager into command processor and all commands
    this.commandProcessor.injectSpatialManager(this.spatialManager);
  }
  ...
  // Move player using object system
